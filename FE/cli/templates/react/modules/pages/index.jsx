  ...
  return <div>
    ...
    <div className="flex justify-end">
      <div className="mb-2 flex space-x-2">
        ...
        <CustomModal width={600}  footer={false} button={({open})=><Button onClick={open} icon={<PlusOutlined />} type="primary">Tạo mới</Button>} title={"Tạo __name__"}>
   ...
   <div className="flex justify-end mb-2">
    ...
    <CustomModal width={600} footer={false} ref={refForm} noButton={true} title={"Sửa __name__"}>
